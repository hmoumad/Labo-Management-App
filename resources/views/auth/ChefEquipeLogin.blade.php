@extends('layouts.app')
@section('title', 'Chef Equipe Login')
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div style="border-radius: 10px;" class="card">
                <div style="background: #424e83; border-radius: 10px 10px 0px 0px;margin: -1px;  height: 55px" class="card-header text-white"><h2 style=";margin-left: 10px;">Chef Equipe Login</h2></div>

                <div style="padding:10px" class="card-body">
                <div style="display: flex;justify-content: center;">
                    <img src="../img/iconelogin1.png" width="150" height="150" style="border-radius: 50%;margin-bottom: 20px; margin-top: 10px; border: 5px solid #424e83">
                </div>
                    
                    <form method="POST" action="{{ route('chef.equipe.CheckLogin') }}">
                        @csrf
                        <?php
                        ...
                        <div style="margin-bottom: 30px !important;" class="row mb-3">
                            ...
                            <div style="margin-left: 10px;" class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Chef Equipe Email">
                        ...
                        <div style="margin-bottom: 30px !important;" class="row mb-3">
                            ...
                            <div style="margin-left: 10px; " class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Chef Equipe Password">
