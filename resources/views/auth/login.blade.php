    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div style="border-radius: 10px;" class="card">
                <div style="background: #424e83; border-radius: 10px 10px 0px 0px;margin: -1px;  height: 55px" class="card-header text-white"><h2 style=";margin-left: 10px;">Admin Login</h2></div>

                <div style="padding:10px" class="card-body">
                <div style="display: flex;justify-content: center;">
                    <img src="img/imgIcon2.png" width="150" height="150" style="border-radius: 50%;margin-bottom: 20px; margin-top: 10px;">
                </div>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div style="margin-bottom: 30px !important;" class="row mb-3">
                            ...
                            <div style="margin-left: 10px; " class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password"placeholder="Admin Password">
