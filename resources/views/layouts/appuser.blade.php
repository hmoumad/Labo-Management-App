                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <!-- Authentication Links -->
                            <li>
                                <a style="font-size: larger; padding-right: 25px; color: white" id="navbarDropdown" class="nav-link " href="{{ route('simple.user.Home') }}" role="button">
                                    Home
                                </a>
                            </li>
                            <li>
                                <a style="font-size: larger; padding-right: 25px; color: white" id="navbarDropdown" class="nav-link " href="{{ route('simple.user.rapport') }}" role="button">
                                    Rapport
                                </a>
                            </li>
                            <li>
                                <a style="font-size: larger; padding-right: 25px; color: white" id="navbarDropdown" class="nav-link " href="{{ route('simple.user.contact') }}" role="button">
                                    Contact
                                </a>
                            </li>
                            </li>
                            ...
                            <li>
                                ...
                                <a onclick="ShowModal('LogOut','Do you really want to leave this page', 'Yes', 'No');
